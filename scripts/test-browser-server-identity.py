...
with tempfile.TemporaryDirectory(prefix="browser-server-identity-") as temporary:
    directory = Path(temporary)
    foreign = directory / "foreign"
    foreign.mkdir()
    fixtures.seed(foreign)
    ...
    runner = subprocess.Popen(["node", str(ROOT / "scripts/verify-calendar-browser.mjs")],
